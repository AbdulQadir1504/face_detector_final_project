...
# Agar local chala rahe hain toh localhost, warna deployment URL yahan aayega
...
def video_frame_callback(frame):
    ...
    # Note: Asli AI processing backend (API) par hoti hai. 
    # Cloud deployment ke liye hum yahan direct processing logic bhi daal sakte hain.
...
with col2:
    ...
    if st.button("🔄 Sync Known Faces"):
        try:
            ...
            st.warning("Backend is offline. Run 'uvicorn api_server:app' first.")
