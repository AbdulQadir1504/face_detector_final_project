...
# Cloud deployment ke liye localhost ki jagah Streamlit ka internal address 
...
with col2:
    ...
    if st.button("🔄 Sync Known Faces"):
        try:
            ...
            st.warning("Backend is offline. Make sure API is running.")
    ...
    try:
        ...
        stats_placeholder.info("Waiting for Backend statistics...")

st.sidebar.markdown("---")
st.sidebar.info("Live Video is now handled by WebRTC for Cloud compatibility.")